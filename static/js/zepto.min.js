...
!function(e, t) {
    ...
    var a, l, o, r, d, s, c, u, m, h, p = "", f = {
        Webkit: "webkit",
        Moz: "",
        O: "o"
    }, v = document.createElement("div"), y = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, b = {};
    e.each(f, function(e, n) {
        return v.style[e + "TransitionProperty"] !== t ? (p = "-" + e.toLowerCase() + "-", a = n, !1) : void 0
    }), l = p + "transform", b[o = p + "transition-property"] = b[r = p + "transition-duration"] = b[s = p + "transition-delay"] = b[d = p + "transition-timing-function"] = b[c = p + "animation-name"] = b[u = p + "animation-duration"] = b[h = p + "animation-delay"] = b[m = p + "animation-timing-function"] = "", e.fx = {
        off: a === t && v.style.transitionProperty === t,
        speeds: {
            _default: 400,
            fast: 200,
            slow: 600
    ...
    }, e.fn.animate = function(n, i, a, l, o) {
        return e.isFunction(i) && (l = i, a = t, i = t), e.isFunction(a) && (l = a, a = t), e.isPlainObject(i) && (a = i.easing, l = i.complete, o = i.delay, i = i.duration), i && (i = ("number" == typeof i ? i : e.fx.speeds[i] || e.fx.speeds._default) / 1e3), o && (o = parseFloat(o) / 1e3), this.anim(n, i, a, l, o)
    }, e.fn.anim = function(i, a, p, f, v) {
        var g, S, T, E = {}, w = "", _ = this, k = e.fx.transitionEnd, O=!1;
        if (a === t && (a = e.fx.speeds._default / 1e3), v === t && (v = 0), e.fx.off && (a = 0), "string" == typeof i)
            E[c] = i, E[u] = a + "s", E[h] = v + "s", E[m] = p || "linear", k = e.fx.animationEnd;
        else {
            S = [];
            for (g in i)
                y.test(g) ? w += g + "(" + i[g] + ") " : (E[g] = i[g], S.push(n(g)));
            w && (E[l] = w, S.push(l)), a > 0 && "object" == typeof i && (E[o] = S.join(", "), E[r] = a + "s", E[s] = v + "s", E[d] = p || "linear")
        }
        return T = function(t) {
            if ("undefined" != typeof t) {
                if (t.target !== t.currentTarget)
                    return;
                e(t.target).unbind(k, T)
            } else
                e(this).unbind(k, T);
            O=!0, e(this).css(b), f && f.call(this)
        }, a > 0 && (this.bind(k, T), setTimeout(function() {
            O || T.call(_)
        }, 1e3 * (a + v) + 25)), this.size() && this.get(0).clientLeft, this.css(E), 0 >= a && setTimeout(function() {
            _.each(function() {
                T.call(this)
            })
        }, 0), this
...
!function(t, e) {
    function n(n, i, a, l, o) {
        "function" != typeof i || o || (o = i, i = e);
        var r = {
            opacity: a
        };
        return l && (r.scale = l, n.css(t.fx.cssPrefix + "transform-origin", "0 0")), n.animate(r, i, null, o)
    }
    function i(e, i, a, l) {
        return n(e, i, 0, a, function() {
            o.call(t(this)), l && l.call(this)
        })
    }
    var a = window.document, l = (a.documentElement, t.fn.show), o = t.fn.hide, r = t.fn.toggle;
    t.fn.show = function(t, i) {
        return l.call(this), t === e ? t = 0 : this.css("opacity", 0), n(this, t, 1, "1,1", i)
    }, t.fn.hide = function(t, n) {
        return t === e ? o.call(this) : i(this, t, "0,0", n)
    }, t.fn.toggle = function(n, i) {
        return n === e || "boolean" == typeof n ? r.call(this, n) : this.each(function() {
            var e = t(this);
        ...
        return n > 0 ? this.css("opacity", 0) : n = 1, l.call(this).fadeTo(t, n, e)
...
var is_int = function(n, iMin, iMax) {
    if (!isFinite(n)) {
        return false
    }
    if (!/^[+-]?\d+$/.test(n)) {
...
var is_float = function(n, fMin, fMax) {
    if (!isFinite(n)) {
        return false
    }
...
var timered = function(time, color) {
    var c = (color == undefined) ? "red": color;
    if (( + new Date() - time) / 1000 > 24 * 3600) {
        return timeline(time)
    } else {
        return '<span style="color:' + c + '">' + timeline(time) + "</span>"
    }
};
...
var strcut = function(str, iMaxBytes, sSuffix) {
    if (isNaN(iMaxBytes)) {
        return str
    }
...
var straddzero = function(num, length) {
...
!function(t) {
    "use strict";
    "function" == typeof define && "object" == typeof define.amd && define.amd ? define(t) : "undefined" != typeof module && module.exports ? module.exports = t() : window.LazyloadImg = t()
}(function() {
    "use strict";
    function t(t) {
        this.el = "[data-src]", this.top = 0, this.right = 0, this.bottom = 0, this.left = 0, this.load = function(t) {}, this.error = function(t) {}, this.qriginal=!1, this.monitorEvent = ["DOMContentLoaded", "load", "click", "touchstart", "touchend", "haschange", "online", "pageshow", "popstate", "resize", "storage", "mousewheel", "scroll"];
        for (var e in t)
            this[e] = t[e];
        this.init()
    }
    return t.prototype.init = function() {
        ...
        var t = this;
        this.src = function() {
            return /\[data-([a-z]+)\]$/.exec(t.el)[1] || "src"
        }(), this.eachDOM = this.eachDOM.bind(this), this.start()
        ...
        for (var t = this.monitorEvent, e = 0; e < t.length; e++)
            window.addEventListener(t[e], this.eachDOM, !1);
        this.eachDOM()
    }, t.prototype.eachDOM = function(t) {
        for (var e = document.querySelectorAll(this.el), n = [], r = 0; r < e.length; r++)
            this.testMeet(e[r])===!0 && n.push(e[r]);
        for (var r = 0; r < n.length; r++)
            this.loadImg(n[r])
    }, t.prototype.testMeet = function(t) {
        var e = t.getBoundingClientRect(), n = t.offsetWidth, r = t.offsetHeight, o = window.innerWidth, i = window.innerHeight, a=!(e.right - this.left <= 0 && e.left + n - this.left <= 0 || e.left + this.right >= o && e.right + this.right >= n + o), s=!(e.bottom - this.top <= 0 && e.top + r - this.top <= 0 || e.top + this.bottom >= i && e.bottom + this.bottom >= r + i);
        return 0 != t.width && 0 != t.height && a && s?!0 : !1
    }, t.prototype.loadImg = function(t) {
        var e = this, n = t.dataset[this.src], r = new Image;
        r.src = n, r.addEventListener("load", function() {
            return e.qriginal ? (t.src = e.getTransparent(t.src, t.width, t.height), t.className += " LazyloadImg-qriginal", t.style.backgroundImage = "url(" + r.src + ")") : t.src = r.src, delete t.dataset[e.src], e.load.call(e, t)
        }, !1), r.addEventListener("error", function() {
            return e.error.call(e, t)
        }, !1)
    }, t.prototype.getTransparent = function() {
        ...
        for (var t = this.monitorEvent, e = 0; e < t.length; e++)
            window.removeEventListener(t[e], this.eachDOM, !1)
    }, t
});
